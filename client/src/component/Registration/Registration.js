        ...
        {!this.state.isElStarted && !this.state.isElEnded ? (
          ...
          <>
            <div className="container-item info">
              <p textAlign="center">Total registered voters: {this.state.voters.length}</p>
            </div>
            <div className="container-main">
              <h3 textAlign="center">Registration</h3>
              <small textAlign="center">Register to vote.</small>
